...
public class Guardar implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Guardar", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Guardar", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Guardar parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Guardar object = new Guardar();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Guardar".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Guardar) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
