...
public class Consultar implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Consultar", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Consultar", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Consultar parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Consultar object = new Consultar();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Consultar".equals(type)) {
                            ...
                            return (Consultar) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
