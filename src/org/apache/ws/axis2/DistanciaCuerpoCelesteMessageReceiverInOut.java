/**
 * DistanciaCuerpoCelesteMessageReceiverInOut.java
 *
...
/**
 *  DistanciaCuerpoCelesteMessageReceiverInOut message receiver
 */
public class DistanciaCuerpoCelesteMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver {
    public void invokeBusinessLogic(
        ...
        try {
            ...
            DistanciaCuerpoCelesteSkeleton skel = (DistanciaCuerpoCelesteSkeleton) obj;
            ...
            if ((op.getName() != null) &&
                ...
                if ("getDistancia".equals(methodName)) {
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            getDistanciaResponse5, false,
                            new javax.xml.namespace.QName(
                                "http://ws.apache.org/axis2",
                                "getDistanciaResponse"));
                } else {
