...
/**
 *  GetDistancia bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetDistancia implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getDistancia", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getDistancia", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDistancia parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetDistancia object = new GetDistancia();
