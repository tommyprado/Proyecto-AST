...
/**
 *  GetDistanciaResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetDistanciaResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ws.apache.org/axis2",
            "getDistanciaResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getDistanciaResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getDistanciaResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDistanciaResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetDistanciaResponse object = new GetDistanciaResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getDistanciaResponse".equals(type)) {
